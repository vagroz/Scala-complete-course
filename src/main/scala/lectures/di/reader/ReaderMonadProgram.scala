...
import lectures.di.{Configuration, ConnectionManagerImpl, UserServiceImpl, UserServiceProgramDeps}
import lectures.functions.{AnonymousUser, User}


case class UserServiceProgramDepsImpl(configuration: Configuration) extends UserServiceProgramDeps {
